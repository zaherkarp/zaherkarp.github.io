export const siteConfig = {
  ...
  presentations: [
    {
      title: "Optimizing Primary Care Teams' EHR Usage",
      event: "AMIA Annual Symposium",
      year: 2014,
      location: "Washington, DC",
    },
    {
      title: "Approaches and Challenges to EHR Optimization in Primary Care",
      event: "World Conference on E-Learning",
      year: 2012,
      location: "Montreal, Canada",
    },
    {
      title: "An Efficient Process of Gathering Diverse Community Opinions to Inform an Intervention",
      event: "3rd Biennial Society for Implementation Research Collaboration Conference",
      year: 2016,
      location: "Seattle, WA",
    },
    {
      title: "Influence of Environmental Design on Team Interactions in Family Medicine Clinics",
      event: "Wisconsin Research and Education Network (WREN) Annual Conference",
      year: 2017,
      location: "Madison, WI",
    },
    {
      title: "Environmental Design and Clinical Workflow: A Mixed Methods Study",
      event: "UW Department of Family Medicine Research Seminar",
      year: 2017,
      location: "Madison, WI",
    },
    {
      title: "Cancer Prevention Screening in Patients with Severe Mental Illness",
      event: "UW Population Health Sciences Seminar",
      year: 2016,
      location: "Madison, WI",
    },
    {
      title: "Behavioral Health Integration Fidelity Assessment",
      event: "Wisconsin Association for Marriage and Family Therapy Conference",
      year: 2016,
      location: "Milwaukee, WI",
    },
    {
      title: "Care Delivery Changes Measured Through Interrupted Time Series",
      event: "Health Innovation Program Research Day",
      year: 2017,
      location: "Madison, WI",
    },
    {
      title: "Medicare Shared Savings Program: Cost Patterns and Savings Achievement",
      event: "AcademyHealth Annual Research Meeting",
      year: 2018,
      location: "Seattle, WA",
    },
    {
      title: "Broadening Medical Students' Exposure to Illness Experiences",
      event: "AAMC Medical Education Meeting",
      year: 2019,
      location: "Phoenix, AZ",
    },
    {
      title: "Analytics for Practice Automation: healthfinch Case Study",
      event: "OCHIN Learning Forum",
      year: 2019,
      location: "Portland, OR",
    },
    {
      title: "Building 0-1 Analytics Infrastructure at a Health Tech Startup",
      event: "Madison Data Community Meetup",
      year: 2020,
      location: "Madison, WI",
    },
    {
      title: "HEDIS Measure Pipeline Architecture with dbt",
      event: "Health Catalyst Analytics Summit",
      year: 2022,
      location: "Salt Lake City, UT",
    },
    {
      title: "Self-Service Analytics Labels for Quality Measurement",
      event: "Health Catalyst Customer Conference",
      year: 2023,
      location: "Virtual",
    },
    {
      title: "Reducing Legacy Storage Costs with S3 Optimization",
      event: "AWS Healthcare & Life Sciences Meetup",
      year: 2024,
      location: "Virtual",
    },
    {
      title: "Medicare Star Ratings: Proactive Analytics for Score Improvement",
      event: "Baltimore Health Analytics Team Summit",
      year: 2025,

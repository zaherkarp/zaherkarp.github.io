---
title: "CI/CD for SQL Developers: From One Commit to a Pipeline"
description: "The default SQL workflow is open a file, write it, run it, commit. It works until it does not. This is the article about how it breaks, what version control and pull requests look like once you outgrow the save-button model, and what a pipeline is supposed to do."
publishDate: 2026-05-17
tags: ["healthcare-data", "ci-cd", "sql", "data-engineering", "version-control", "pull-requests"]
---

# CI/CD for SQL Developers: From One Commit to a Pipeline

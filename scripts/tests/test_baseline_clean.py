...
Each of the eight gate linters is run in-process against the REAL repo
...
eight linters, so the full pre-push gate is characterized as green.
"""
...
# (module_name, entrypoint_attr) for each of the eight gate linters.
LINTERS = [
    ("lint_blog", "main"),
    ("lint_vocab", "main"),
    ("lint_facts", "main"),
